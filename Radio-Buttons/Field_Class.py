...
class Field:
    ...
    def grow(self,light,food,water):
        ...
        if len(self._animals) > 0:
            #grow the animals (water available to all the animals in the same amount)
            #but food is a total number that must be shared
            food_required = 0
            #get a total of the food required by the animals in the field
            for animal in self._animals:
                needs = animal.needs()
                food_required += needs["food need"]
            #if we have more food availabe than is required work out the additional
            #available food
            ...
            for animal in self._animals:
                ...
                if food  >= needs["food need"]:
                    #remove food for this animalfrom total
                    food -= needs["food need"]
    ...
    while not valid:
        try:
            ...
            if 1 <= light <= 10:
                ...
                print("Value entered not valid - please enter a vlaue between 1 and 10")
        except ValueError:
            print("Value entered not valid - please enter a vlaue between 1 and 10")
    ...
    while not valid:
        try:
            ...
            if 1 <= food <= 100:
                ...
                print("Value entered not valid - please enter a vlaue between 1 and 100")
        except ValueError:
            print("Value entered not valid - please enter a vlaue between 1 and 100")
